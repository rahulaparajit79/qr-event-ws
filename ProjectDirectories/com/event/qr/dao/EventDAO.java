...
cstatement.setDate("p_eventDate", event.getEventDate());
cstatement.setDate("p_eventStartTime", event.getEventStartTime());
cstatement.setDate("p_eventEndTime", event.getEventEndTime());
