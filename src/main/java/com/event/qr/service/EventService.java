...
public class EventService {
	...
	public ResponseList<Event> getAllEventsWinner() {
	...
	public ResponseList<UserScore> getWinnerByEvent(int eventId) {

		ResponseList<UserScore> responseList = null;
		ArrayList<UserScore> userList = null;

		userList = eventdao.getEventWinner(eventId);
	...
	public ResponseList<UserScore> getAllEventWinner() {

		ResponseList<UserScore> responseList = null;
		ArrayList<UserScore> userList = null;

		userList = eventdao.getAllEventWinner();
	...
	public ResponseList<Event> getAllClosedEvents() {

		ResponseList<Event> responseList = null;
		ArrayList<Event> eventList = null;

		eventList = eventdao.getAllClosedEvents();
	...
	private String validateEvent(Event event) {
		...
		if (count == -1) {
			...
			return status = "An event is already scheduled between this time span, " + "please choose other time span.";
		}
		return status;
	}
